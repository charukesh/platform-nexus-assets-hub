...
export const enhanceAsset = (asset: any): Asset => {
  return {
    ...
    cost_per_day: typeof asset.cost_per_day === 'number' ? asset.cost_per_day : 0,
    targeting_score: typeof asset.targeting_score === 'number' ? asset.targeting_score : 0,
    allocated_budget: typeof asset.allocated_budget === 'number' ? asset.allocated_budget : 0,
    estimated_impressions: typeof asset.estimated_impressions === 'number' ? asset.estimated_impressions : 0,
